	...
	public static function calculaTotalAProvisionarUnicoFormando($codFormatura,$codFormando) {
		...
		try {
			...
			FROM	(
				...
				FROM	(
					SELECT  U.CODIGO,U.CPF,U.NOME,IFNULL(D.VALOR_MULTA,0) VALOR_MULTA,SUM(IF((E.COD_TIPO_PRECO = 'V'),E.VALOR_AVULSO,ROUND((OF.VALOR_PREVISTO_TOTAL/OF.QTDE_PREVISTA_FORMANDOS)*E.PCT_VALOR_ORCAMENTO/100,2))) AS total
					FROM	ZGSEG_USUARIO 				U,
							ZGADM_ORGANIZACAO			O,
							ZGSEG_PERFIL				P,
							ZGFMT_ORGANIZACAO_FORMATURA	OF,
