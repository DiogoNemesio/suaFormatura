<?php
namespace Zage\Fin\Arquivos\Layout\BOL_T240;

/**
 * @package: \Zage\Fin\Arquivos\Layout\BOL_T240\TipoRegistro
 * @created: 30/06/2015
...
abstract class TipoRegistro {
	...
	public function setConfigFromDB() {
		...
		# Código do segmento
		#################################################################################
		$codSegmento		= ($this->getCodSegmento()) ? $this->getCodSegmento() : null; 
		
		#################################################################################
		# Resgata as informações do tipo de registro do banco
		#################################################################################
		$info	= $em->getRepository('\Entidades\ZgfinArquivoRegistroTipo')->findOneBy(array('codTipoRegistro' => $this->getTipoRegistro(),'codTipoArquivo' => $this->getTipoArquivo(),'codSegmento' => $codSegmento));
	...
	private function _listaCampos() {
		...
		$tipoRegistro	=	$em->getRepository('\Entidades\ZgfinArquivoRegistroTipo')->findOneBy(array('codTipoRegistro' => $this->getTipoRegistro(),'codTipoArquivo' => $this->getTipoArquivo(),"codSegmento" => $codSegmento));
	 ...
	 */
	public function setCodSegmento($codSegmento) {
