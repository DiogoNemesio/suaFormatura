...
/**
 * ZgforEnqueteResposta
 *
 * @ORM\Table(name="ZGFOR_ENQUETE_RESPOSTA", indexes={@ORM\Index(name="fk_ZGFOR_ENQUETE_RESPOSTA_1_idx", columns={"COD_PERGUNTA"}), @ORM\Index(name="fk_ZGFOR_ENQUETE_RESPOSTA_2_idx", columns={"COD_USUARIO"})})
 * @ORM\Entity
 */
class ZgforEnqueteResposta
{
    /**
     * @var integer
     *
    ...
    /**
     * @var \Entidades\ZgforEnquetePergunta
     *
     * @ORM\ManyToOne(targetEntity="Entidades\ZgforEnquetePergunta")
     * @ORM\JoinColumns({
     ...
     * Set codPergunta
     *
     * @param \Entidades\ZgforEnquetePergunta $codPergunta
     * @return ZgforEnqueteResposta
     */
    public function setCodPergunta(\Entidades\ZgforEnquetePergunta $codPergunta = null)
    {
     ...
     * Get codPergunta
     *
     * @return \Entidades\ZgforEnquetePergunta 
     */
