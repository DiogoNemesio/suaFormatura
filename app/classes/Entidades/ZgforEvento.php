 ...
 * ZgforEvento
 *
 * @ORM\Table(name="ZGFOR_EVENTO", indexes={@ORM\Index(name="fk_ZGFOR_EVENTO_1_idx", columns={"COD_TIPO_EVENTO"}), @ORM\Index(name="fk_ZGFOR_EVENTO_2_idx", columns={"COD_FORMATURA"}), @ORM\Index(name="fk_ZGFOR_EVENTO_3_idx", columns={"COD_LOGRADOURO"}), @ORM\Index(name="ZGFOR_EVENTO_1_UN", columns={"COD_FORMATURA", "COD_TIPO_EVENTO"})})
 * @ORM\Entity
 */
class ZgforEvento
{
    ...
    /**
     * @var \Entidades\ZgforEventoTipo
     *
     * @ORM\ManyToOne(targetEntity="Entidades\ZgforEventoTipo")
     * @ORM\JoinColumns({
     ...
     * Set codTipoEvento
     *
     * @param \Entidades\ZgforEventoTipo $codTipoEvento
     * @return ZgforEvento
     */
    public function setCodTipoEvento(\Entidades\ZgforEventoTipo $codTipoEvento = null)
    {
     ...
     * Get codTipoEvento
     *
     * @return \Entidades\ZgforEventoTipo 
     */
