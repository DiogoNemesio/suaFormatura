...
$mensagem[]	= "Que sorte, você foi convidado para o nosso casamento!!! Não perca a hora, as localizações estão abaixo:
		
		
Enviado com www.midiawap.com.br";
...
while ($atual < $total) {
	...
	try {
		...
		$w[$chip]->sendMessageLocation($numero, "-35.730949", "-9.649204", "Igreja", "www.anamiele.com.br");
		$w[$chip]->sendMessageLocation($numero, "-35.730949", "-9.649204", "Recepção", "www.anamiele.com.br");
