...
try {
	...
	$podeFinalizar	= null;
	$mensagem		= $tr->trans('Deseja realmente finalizar a Enquete').': <em><b>'.$info->getDescricao().'</b></em> ?';
	$classe			= "text-warning";
...
$tpl->load(HTML_PATH . '/templateFin.html');
...
$tpl->set('PODE_FINALIZAR'		,$podeFinalizar);
$tpl->set('TITULO'				,$tr->trans('Finalizar Enquete'));
$tpl->set('ID'					,$id);
