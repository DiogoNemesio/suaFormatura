...
$aStatus	= array("A","P","L");
try {
	$contas	= \Zage\Fin\ContaReceber::listaPorCategoria($dataIni,$dataFim,"V",null,null,null,$aStatus,null,null,null,null,null); 
} catch (\Exception $e) {
...
for ($i = 0; $i < sizeof($contas); $i++) {
	...
	$data[$i]["label"]	= htmlentities($contas[$i]["categoria"]);
