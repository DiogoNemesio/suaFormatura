...
$grid->adicionaTexto($tr->trans('VENCIMENTO'),			15	,$grid::CENTER	,'usuario');
$grid->adicionaTexto($tr->trans('Nº DA CONTA'),			15	,$grid::CENTER	,'nome');
$grid->adicionaTexto($tr->trans('VALOR'),				12	,$grid::CENTER	,'cpf','cpf');
$grid->adicionaTexto($tr->trans('VALOR ATUALIZADO'),	12	,$grid::CENTER	,'rg');
$grid->adicionaTexto($tr->trans('STATUS'),				12	,$grid::CENTER	,'rg');
