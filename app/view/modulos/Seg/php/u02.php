...
if ($oUsuario->getCodStatus()->getCodigo() != "P" ){
	if ($oUsuOrg->getCodStatus()->getCodigo() != "P"){
		\Zage\App\Erro::externalHalt('Convite não está mais disponível, COD_ERRO: 07');
	}
}
...
$rg							= ($oUsuario->getRg()) ? $oUsuario->getRg() : null;
$dataNasc					= ($oUsuario->getDataNascimento()) ? $oUsuario->getDataNascimento()->format($system->config["data"]["dateFormat"]) : null;
