...
try {
	...
	if (!isset($codEndereco) || (!$codEndereco)) {
	...
	if (!$oEndereco) {
		$system->criaAviso(\Zage\App\Aviso\Tipo::ERRO,$tr->trans('Endereço não encontrado'));
		die('1'.\Zage\App\Util::encodeUrl('||'));
	}
...
$system->criaAviso(\Zage\App\Aviso\Tipo::INFO,$tr->trans("Endereço excluído com sucesso"));
