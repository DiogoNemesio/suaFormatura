...
#################################################################################
if (!isset($codCargo)) 		{
	\Zage\App\Erro::halt($tr->trans('Falta de Parâmetros').' (COD_CARGO)');
}
...
$tpl->set('TITULO'				,$tr->trans('Exclusão de Cargo'));
$tpl->set('ID'					,$id);
$tpl->set('TEXTO'				,$mensagem);
$tpl->set('MENSAGEM'			,$mensagem);
$tpl->set('CLASSE'				,$classe);
$tpl->set('VAR'					,'codCargo');
$tpl->set('VAR_VALUE'			,$info->getCodigo());
$tpl->set('CARGO'				,$info->getDescricao());
