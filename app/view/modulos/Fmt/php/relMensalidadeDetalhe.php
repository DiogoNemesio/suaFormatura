...
## Url desse script
#################################################################################
$urlForm			= ROOT_URL . '/Fmt/relMensalidadeDetalhe.php'; 
...
if (sizeof($aValoresPagos) > 0) {
	foreach ($aValoresPagos as $cpf => $dados) {
		...
		$aValores[$cpf]["jurosLiq"]			= (\Zage\App\Util::to_float($dados["juros"])  * $pctJuros	/ 100);
		$aValores[$cpf]["moraLiq"]			= (\Zage\App\Util::to_float($dados["mora"])  * $pctMora	/ 100);
		...
		$aValores[$cpf]["totalPago"]		= \Zage\App\Util::to_float($dados["sistema"]) + \Zage\App\Util::to_float($dados["mensalidade"]) + \Zage\App\Util::to_float($dados["outros"]) + \Zage\App\Util::to_float($dados["juros"]) + \Zage\App\Util::to_float($dados["mora"]);
		$aValores[$cpf]["totalTarifa"]		= \Zage\App\Util::to_float($dados["sistema"]) + \Zage\App\Util::to_float($dados["outros"]);
	}
}
...
if (sizeof($aValores) > 0) {
	...
	foreach ($aValores as $cpf => $dados) {
		...
		$aDados[$nome]["jurosLiq"]			= $aValores[$cpf]["jurosLiq"] + $aValores[$cpf]["moraLiq"];
		...
		$aDados[$nome]["totalArrecadado"]	= $aValores[$cpf]["totalArrecadado"];
		...
		$aDados[$nome]["totalTarifa"]		= $aValores[$cpf]["totalTarifa"];
	...
	foreach ($aDados as $nome => $dados) {
		...
		$table .= '<tr style="background-color:#FDF5E6">
						<th style="text-align: center; border-left: 1px solid #000000; border-right: 1px solid #000000;" colspan="4"><strong>Créditos</strong></th>
						...
						<th style="text-align: center; border-left: 1px solid #000000; border-right: 1px solid #000000;" colspan="5"><strong>Totais</strong></th>
				</tr>';
		$table .= '<tr style="background-color:#FDF5E6;">
						<th style="text-align: center; width: 10%; border-left: 1px solid #000000;"><strong>Mensalidades</strong></th>
						<th style="text-align: center; width: 7%;"><strong>Juros</strong></th>
						<th style="text-align: center; width: 7%;"><strong>Portal</strong></th>
						<th style="text-align: center; width: 7%;"><strong>Outros</strong></th>
						<th style="text-align: center; width: 10%; border-left: 1px solid #000000;"><strong>Mensalidades</strong></th>
						<th style="text-align: center; width: 7%;"><strong>Portal</strong></th>
						<th style="text-align: center; width: 7%;"><strong>Outros</strong></th>
						<th style="text-align: center; width: 10%; border-left: 1px solid #000000;"><strong>Gerado</strong></th>
						<th style="text-align: center; width: 10%;"><strong>Arrecado</strong></th>
						<th style="text-align: center; width: 10%;"><strong>Tarifas</strong></th>
						<th style="text-align: center; width: 10%;"><strong>Devolvido</strong></th>
						<th style="text-align: center; width: 10%; border-right: 1px solid #000000;"><strong>Saldo</strong></th>
				</tr>';
		$table .= '';
		$table .= '<tr>
						...
						<td style="text-align: center; width: 7%; border-bottom: 1px solid #000000;">'.\Zage\App\Util::to_money($dados["jurosLiq"]).'</td>
						<td style="text-align: center; width: 7%; border-bottom: 1px solid #000000;">'.\Zage\App\Util::to_money($dados["sistema"]).'</td>
						<td style="text-align: center; width: 7%; border-bottom: 1px solid #000000;">'.\Zage\App\Util::to_money($dados["outros"]).'</td>
						...
						<td style="text-align: center; width: 7%; border-bottom: 1px solid #000000;">'.\Zage\App\Util::to_money($dados["devOutras"]).'</td>
						<td style="text-align: center; width: 10%; border-bottom: 1px solid #000000;"><strong>'.\Zage\App\Util::to_money($dados["provisionado"]).'</strong></td>
						...
						<td style="text-align: center; width: 10%; border-bottom: 1px solid #000000;"><strong>'.\Zage\App\Util::to_money($dados["totalTarifa"]).'</strong></td>
						...
						<td style="text-align: center; width: 10%; border-right: 1px solid #000000; border-bottom: 1px solid #000000;"><strong>'.\Zage\App\Util::to_money($dados["mensalidade"]).'</strong></td>
					</tr>';
		$table .= '</tbody>';
...
if ($geraPdf == 1) {
	...
	$html	.= '<table style="width: 100%;" class="table-condensed">
			<tr><td style="width: 70%;">
				<h4 align="center"><strong>Detalhe das mensalidades</strong></h4>
				</td>
	...
	$html	= '<table style="width: 100%;" class="table-condensed">
			<tr><td style="width: 70%;">
				<h4 align="center"><strong>Detalhe das mensalidades</strong> - '.$oOrg->getNome().'</h4>
				</td>
				<td rowspan="2" align="right" style="width: 30%;">'.$tableTotal.'</td>
			</tr>
